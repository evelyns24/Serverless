...
module.exports = async function (context, req) {
    ...
    let download = ""
    let downloadpng = "https://storageaccountbitproj.blob.core.windows.net/images/" + username + ".png";
    let downloadjpg = "https://storageaccountbitproj.blob.core.windows.net/images/" + username + ".jpeg";
